...
if (bots.length < c.BOTS) {
                    ...
                    o.color = 17;
                    o.define(Class.bot);
                                      let arrayOfClasses = [Class.basic, Class.twin, Class.sniper, Class.machine, Class.flank, Class.director, Class.trapper, Class.pound,
        Class.single,

Class.smash,
Class.megasmash, Class.spike, Class.autosmash,

Class.double, Class.bent, Class.gunner, Class.hexa,
Class.triple,
Class.tripletwin, Class.split, Class.autodouble, Class.bentdouble,
Class.penta, Class.spread, Class.benthybrid, Class.bentdouble, Class.triple,
Class.autogunner, Class.nailgun, Class.auto4,Class.machinegunner,

Class.assassin, Class.hunter, Class.mini, Class.builder,
   Class.bushwhack,
        Class.ranger, Class.falcon,
      Class.preda, Class.poach, Class.sidewind,
      Class.construct, Class.autobuilder, Class.engineer, Class.boomer,

 Class.artillery, Class.mini, Class.gunner,
   Class.spray,
     Class.anni, Class.hybrid, Class.construct, Class.shotgun2, Class.hiveshooter,
    Class.mortar, Class.spread, Class.skimmer,
        Class.stream, Class.nailgun,

Class.hexa, Class.tri, Class.auto3, Class.flanktrap,
        
      Class.fighter, Class.booster, Class.falcon, Class.bomber, Class.autotri,
   Class.octo, Class.hexatrap,
    Class.auto5, Class.heavy3, Class.auto4,
    Class.bushwhack, Class.guntrap, Class.fortress, Class.bomber,

Class.overseer, Class.cruiser, Class.underseer,
Class.factory,
Class.overlord, Class.overtrap, Class.overgunner,  
Class.necromancer,
Class.carrier, Class.battleship, Class.fortress,
Class.trapper3, Class.megatrap, Class.flanktrap, Class.contag,
Class.destroy, Class.builder,]
